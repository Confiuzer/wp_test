...
class PlaysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create play" do
    assert_difference('Play.count') do
      post plays_url, params: { play: { game_id: @play.game_id, image_url: @play.image_url, tick: @play.tick } }
    end
  ...
  test "should update play" do
    patch play_url(@play), params: { play: { game_id: @play.game_id, image_url: @play.image_url, tick: @play.tick } }
